 ...
 *     {@link javan.util.function.Function} (unary function from {@code T} to {@code R}),
 *     {@link javan.util.function.Consumer} (unary function from {@code T} to {@code void}),
 *     {@link javan.util.function.Predicate} (unary function from {@code T} to {@code boolean}),
 *     and {@link javan.util.function.Supplier} (nilary function to {@code R}).
 *     </li>
 *
 ...
 *     {@link javan.util.function.BiFunction} (binary function from {@code T} and
 *     {@code U} to {@code R}).
 *     </li>
 *
 *     <li>There are additional derived function shapes which extend the basic
 *     function shapes, including {@link javan.util.function.UnaryOperator}
 *     (extends {@code Function}) and {@link javan.util.function.BinaryOperator}
 ...
 *     prefix {@code ToXxx}, as in {@link javan.util.function.ToIntFunction}.
 *     Otherwise, type arguments are specialized left-to-right, as in
 *     {@link javan.util.function.DoubleConsumer}
 *     or {@link javan.util.function.ObjIntConsumer}.
 ...
 *     as in {@link javan.util.function.ObjIntConsumer}.)
 ...
 *     prefix may be left out (as in {@link javan.util.function.ObjIntConsumer}).
 *     </li>
 * </ul>
 *
