...
public class PartitionArrayIntoThreePartsWithEqualSum_1013 {
	...
	public static void main(String[] args) {
		...
		PartitionArrayIntoThreePartsWithEqualSum_1013 s = new PartitionArrayIntoThreePartsWithEqualSum_1013();
		...
		boolean result = s.canThreePartsEqualSum(arr);
