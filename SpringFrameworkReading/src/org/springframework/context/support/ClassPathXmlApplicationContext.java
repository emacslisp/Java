 ...
 * the class path, interpreting plain paths as class path resource names that
 * include the package path (e.g. "mypackage/myresource.txt"). Useful for test
 * harnesses as well as for application contexts embedded within JARs.
 *
 * <p>
...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	/**
	 * Create a new ClassPathXmlApplicationContext, loading the definitions from the
	...
	/**
	 * Create a new ClassPathXmlApplicationContext with the given parent, loading
	 ...
	 * 
	 * @param configLocations array of resource locations
	 * @param refresh         whether to automatically refresh the context, loading
	 *                        all bean definitions and creating all singletons.
	 *                        Alternatively, call refresh manually after further
	 ...
	 * Class. For full flexibility, consider using a GenericApplicationContext with
	 * an XmlBeanDefinitionReader and a ClassPathResource argument.
	 * 
