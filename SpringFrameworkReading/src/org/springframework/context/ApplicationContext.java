...
public interface ApplicationContext extends EnvironmentCapable, ListableBeanFactory, HierarchicalBeanFactory,
	 ...
	 * serves as a convenient, specific facility on the ApplicationContext
	 * interface.
	 * <p>
	 * <b>NOTE: As of 4.2, this method will consistently throw IllegalStateException
	 * after the application context has been closed.</b> In current Spring
	 * Framework versions, only refreshable application contexts behave that way; as
	 * of 4.2, all application context implementations will be required to comply.
	 * 
	 * @return the AutowireCapableBeanFactory for this context
	 * @throws IllegalStateException if the context does not support the
	 *                               {@link AutowireCapableBeanFactory} interface,
	 *                               or does not hold an autowire-capable bean
	 *                               factory yet (e.g. if {@code refresh()} has
