...
/**
 * SAX {@code XMLReader} that reads from a StAX {@code XMLStreamReader}. Reads
 * from an {@code XMLStreamReader}, and calls the corresponding methods on the
...
class StaxStreamXMLReader extends AbstractStaxXMLReader {
	...
	/**
	 * Construct a new instance of the {@code StaxStreamXmlReader} that reads from
	 * the given {@code XMLStreamReader}. The supplied stream reader must be in
