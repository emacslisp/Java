 ...
 * to a {@link javax.xml.stream.util.XMLEventConsumer}.
 *
...
class StaxEventHandler extends AbstractStaxHandler {
	...
	/**
	 * Construct a new instance of the {@code StaxEventContentHandler} that writes
	 * to the given {@code XMLEventWriter}. A default {@code XMLEventFactory} will
	 * be created.
	 * 
	...
	/**
	 * Construct a new instance of the {@code StaxEventContentHandler} that uses the
	 * given event factory to create events and writes to the given
