...
/**
 * Abstract base class for SAX {@code XMLReader} implementations that use StAX
 * as a basis.
 *
...
abstract class AbstractStaxXMLReader extends AbstractXMLReader {
	 ...
	 * {@code http://xml.org/sax/features/namespaces} is turned on.
	 */
	...
	/**
	 * Convert a {@code QName} to a qualified name, as used by DOM and SAX. The
	 * returned string has a format of {@code prefix:localName} if the prefix is
	 * set, or just {@code localName} if not.
	 * 
