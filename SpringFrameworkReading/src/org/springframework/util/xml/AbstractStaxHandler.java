 ...
 * implementations that use StAX as a basis. All methods delegate to internal
 * template methods, capable of throwing a {@code XMLStreamException}.
 * Additionally, an namespace context stack is used to keep track of declared
 * namespaces.
 *
...
abstract class AbstractStaxHandler implements ContentHandler, LexicalHandler {
	 ...
	 * qualified name can have the form {@code prefix:localname} or
	 * {@code localName}.
	 * 
