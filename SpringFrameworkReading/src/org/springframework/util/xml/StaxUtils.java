...
/**
 * Convenience methods for working with the StAX API. Partly historic due to
 * JAXP 1.3 compatibility; as of Spring 4.0, relying on JAXP 1.4 as included in
 * JDK 1.6 and higher.
 *
 * <p>
 * In particular, methods for using StAX ({@code javax.xml.stream}) in
 * combination with the TrAX API ({@code javax.xml.transform}), and converting
...
public abstract class StaxUtils {
	...
	/**
	 * Create an {@link XMLInputFactory} with Spring's defensive setup, i.e. no
	 * support for the resolution of DTDs and external entities.
	 * 
	...
	/**
	 * Indicate whether the given {@link Source} is a JAXP 1.4 StAX Source or custom
	 * StAX Source.
	 * 
	...
	/**
	 * Indicate whether the given {@link Result} is a JAXP 1.4 StAX Result or custom
	 * StAX Result.
	 * 
	 ...
	 * Useful because the StAX {@code XMLInputFactory} allows one to create an event
