...
public abstract class AbstractNestablePropertyAccessor extends AbstractPropertyAccessor {
	 ...
	 *                               suppressed if the accessor won't need any type
	 *                               conversion)
	 * @see #setWrappedInstance
	 */
	...
	/**
	 * Create a new accessor for the given object, registering a nested path that
	 * the object is in.
	 * 
	 * @param object     object wrapped by this accessor
	...
	/**
	 * Recursively navigate to return a property accessor for the nested property
	 * path.
	 * 
	...
	/**
	 * Retrieve a Property accessor for the given nested property. Create a new one
	 * if not found in the cache.
	 * <p>
	 * Note: Caching nested PropertyAccessors is necessary now, to keep registered
