...
/**
 * Common interface for classes that can access named properties (such as bean
 * properties of an object or fields in an object) Serves as base interface for
 * {@link BeanWrapper}.
 *
...
public interface PropertyAccessor {
	...
	/**
	 * Marker that indicates the start of a property key for an indexed or mapped
	 ...
	 * property descriptor or checking the value in case of an indexed or mapped
	 * element.
	 * 
	 * @param propertyName the property to check (may be a nested path and/or an
	 *                     indexed/mapped property)
	 ...
	 * @throws PropertyAccessException  if the property was valid but the accessor
	 *                                  method failed or a type mismatch occurred
	 */
	 ...
	 * <p>
	 * Bulk updates from PropertyValues are more powerful: This method is provided
	 * for convenience. Behavior will be identical to that of the
	 ...
	 *                                      occurred for specific properties during
	 *                                      the batch update. This exception bundles
	 *                                      all individual PropertyAccessExceptions.
	 *                                      All other properties will have been
	 ...
	 * in that an implementation of this class will continue to update properties if
	 * a <b>recoverable</b> error (such as a type mismatch, but <b>not</b> an
	 ...
	 * that were successfully updated remain changed.
	 * <p>
	 ...
	 * 
	 * @param pvs           a PropertyValues to set on the target object
	 * @param ignoreUnknown should we ignore unknown properties (not found in the
	 *                      bean)
	 * @throws InvalidPropertyException     if there is no such property or if the
	 *                                      property isn't writable
	 * @throws PropertyBatchUpdateException if one or more PropertyAccessExceptions
	 ...
	 * @param ignoreUnknown should we ignore unknown properties (not found in the
	 *                      bean)
	 * @param ignoreInvalid should we ignore invalid properties (found but not
	 *                      accessible)
	 * @throws InvalidPropertyException     if there is no such property or if the
	 *                                      property isn't writable
	 * @throws PropertyBatchUpdateException if one or more PropertyAccessExceptions
