 ...
 *
 * <p>
 * Works on a given {@link PropertyEditorRegistrySupport} instance. Used as a
 * delegate by {@link BeanWrapperImpl} and {@link SimpleTypeConverter}.
 *
...
class TypeConverterDelegate {
	 ...
	 * 
	 * @param propertyEditorRegistry the editor registry to use
	 * @param targetObject           the target object to work on (as context that
	 *                               can be passed to editors)
	 */
	 ...
	 * @param requiredType the type we must convert to (or {@code null} if not
	...
	/**
	 * Convert the value to the required type (if necessary from a String), using
	 * the given property editor.
	 * 
	 * @param oldValue     the previous value, if available (may be {@code null})
	 * @param newValue     the proposed new value
	 * @param requiredType the type we must convert to (or {@code null} if not
