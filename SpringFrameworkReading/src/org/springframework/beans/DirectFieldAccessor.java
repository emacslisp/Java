 ...
 * traversal as well as collections and map access is now supported here as
 * well.
 *
 * <p>
 * A DirectFieldAccessor's default for the "extractOldValueForEditor" setting is
 * "true", since a field can always be read without side effects.
 *
...
public class DirectFieldAccessor extends AbstractNestablePropertyAccessor {
	...
	/**
	 * Create a new DirectFieldAccessor for the given object, registering a nested
	 * path that the object is in.
	 * 
	 * @param object     object wrapped by this DirectFieldAccessor
	 * @param nestedPath the nested path of the object
	 * @param parent     the containing DirectFieldAccessor (must not be
	 *                   {@code null})
	 */
