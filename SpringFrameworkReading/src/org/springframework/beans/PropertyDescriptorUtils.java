...
abstract class PropertyDescriptorUtils {
	...
	public static void copyNonMethodProperties(PropertyDescriptor source, PropertyDescriptor target)
	{
		...
		// Copy all attributes (emulating behavior of private
		// FeatureDescriptor#addTable)
	...
	/**
	 * Compare the given {@code PropertyDescriptors} and return {@code true} if they
	 * are equivalent, i.e. their read method, write method, property type, property
