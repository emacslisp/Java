...
/**
 * Holder containing one or more {@link PropertyValue} objects, typically
 * comprising one update for a specific target bean.
 *
 * @author Rod Johnson
...
public interface PropertyValues extends Iterable<PropertyValue> {
	 ...
	 * @return the updated or new properties. Return empty PropertyValues if there
	 *         are no changes.
	 * @see Object#equals
	 */
