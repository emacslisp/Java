...
public abstract class BeanUtils {
	 ...
	 *             unspecified parameter, Kotlin optional parameters and Java
	...
	/**
	 * Return the primary constructor of the provided class. For Kotlin classes,
	 * this returns the Java constructor corresponding to the Kotlin primary
	 * constructor (as defined in the Kotlin specification). Otherwise, in
	 * particular for non-Kotlin classes, this simply returns {@code null}.
	 * 
	 * @param clazz the class to check
	 * @since 5.0
	 * @see <a href=
	 *      "https://kotlinlang.org/docs/reference/classes.html#constructors">Kotlin
	 *      docs</a>
	 */
	@SuppressWarnings("unchecked")
	@Nullable
	 ...
	 * names, and attempts to resolve that signature against the supplied
	 * {@code Class}.
	 * <p>
	 * When not supplying an argument list ({@code methodName}) the method whose
	 * name matches and has the least number of parameters will be returned. When
	 * supplying an argument type list, only the method whose name and argument
	 ...
	 * {@code methodName} means the method called {@code methodName} with the least
	 * number of arguments, whereas {@code methodName()} means the method called
	 * {@code methodName} with exactly 0 arguments.
	 * <p>
	...
	public static PropertyEditor findEditorByConvention(@Nullable Class<?> targetType)
	{
		...
		try {
			...
			if (logger.isTraceEnabled()) {
				logger.trace("No property editor [" + editorName + "] found for type " + targetType.getName()
	 ...
	 * or other CharSequence, a Number, a Date, a Temporal, a URI, a URL, a Locale,
	 * a Class, or a corresponding array.
	 * <p>
	 ...
	 * enum, a String or other CharSequence, a Number, a Date, a Temporal, a URI, a
	 * URL, a Locale or a Class.
	 * 
	 * @param clazz the type to check
	...
	public static boolean isSimpleValueType(Class<?> clazz)
	{
		return (ClassUtils.isPrimitiveOrWrapper(clazz) || Enum.class.isAssignableFrom(clazz)
				...
				|| Date.class.isAssignableFrom(clazz) || Temporal.class.isAssignableFrom(clazz) || URI.class == clazz
	...
	private static class KotlinDelegate {
		...
		/**
		 * Retrieve the Java constructor corresponding to the Kotlin primary
		 * constructor, if any.
		 * 
