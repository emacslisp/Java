...
/**
 * Default {@link BeanWrapper} implementation that should be sufficient for all
 * typical use cases. Caches introspection results for efficiency.
 *
 * <p>
 * Note: Auto-registers default property editors from the
 * {@code org.springframework.beans.propertyeditors} package, which apply in
 * addition to the JDK's standard PropertyEditors. Applications can call the
 * {@link #registerCustomEditor(Class, java.beans.PropertyEditor)} method to
 * register an editor for a particular instance (i.e. they are not shared across
 * the application). See the base class {@link PropertyEditorRegistrySupport}
 * for details.
 *
 * <p>
 * <b>NOTE: As of Spring 2.5, this is - for almost all purposes - an internal
 * class.</b> It is just public in order to allow for access from other
 * framework packages. For standard application access purposes, use the
...
public class BeanWrapperImpl extends AbstractNestablePropertyAccessor implements BeanWrapper {
	...
	/**
	 * Create a new empty BeanWrapperImpl. Wrapped instance needs to be set
	 * afterwards. Registers default editors.
	 * 
	 ...
	 *                               suppressed if the BeanWrapper won't need any
	 *                               type conversion)
	 * @see #setWrappedInstance
	 */
	...
	/**
	 * Create a new BeanWrapperImpl for the given object, registering a nested path
	...
	/**
	 * Obtain a lazily initialized CachedIntrospectionResults instance for the
	 * wrapped object.
	 */
	 ...
	 * @param propertyName the target property (note that nested or indexed
