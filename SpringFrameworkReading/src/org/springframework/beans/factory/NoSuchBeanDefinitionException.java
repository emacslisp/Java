...
/**
 * Exception thrown when a {@code BeanFactory} is asked for a bean instance for
 * which it cannot find a definition. This may point to a non-existing bean, a
 * non-unique bean, or a manually registered singleton instance without an
...
public class NoSuchBeanDefinitionException extends BeansException {
	...
	/**
	 * Return the required {@link ResolvableType} of the missing bean, if it was a
