 ...
 * document reading to an implementation of the
 * {@link BeanDefinitionDocumentReader} interface.
 *
 * <p>
 ...
 * to it. The document reader will register each bean definition with the given
 * bean factory, talking to the latter's implementation of the
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 * <p>
	 * This method switches namespace awareness on if validation is turned off, in
	 * order to still process schema namespaces properly in such a scenario.
	 * 
	 ...
	 * "false".
	 * <p>
	 * This is typically not needed when schema validation is active. However,
	 * without validation, this has to be switched to "true" in order to properly
	 * process schema namespaces.
	 */
	...
	/**
	 * Specify which
	 * {@link org.springframework.beans.factory.parsing.ProblemReporter} to use.
	 * <p>
	 * The default implementation is
	 * {@link org.springframework.beans.factory.parsing.FailFastProblemReporter}
	 * which exhibits fail fast behaviour. External tools can provide an alternative
	 ...
	 * <p>
	 * The default implementation is EmptyReaderEventListener which discards every
	 * event notification. External tools can provide an alternative implementation
	 * to monitor the components being registered in the BeanFactory.
	 */
	 ...
	 * <p>
	 * The default implementation is {@link NullSourceExtractor} which simply
	 * returns {@code null} as the source object. This means that - during normal
	 * runtime execution - no additional source metadata is attached to the bean
	 ...
	 * for custom entity resolution, for example relative to some specific base
	 * path.
	 */
	...
	/**
	 * Return the EntityResolver to use, building a default resolver if none
	 * specified.
	 */
	...
	/**
	 * Set an implementation of the {@code org.xml.sax.ErrorHandler} interface for
	 * custom handling of XML parsing errors and warnings.
	 * <p>
	 * If not set, a default SimpleSaxErrorHandler is used that simply logs warnings
	 * using the logger instance of the view class, and rethrows errors to
	 ...
	 * 
	 * @param documentReaderClass the desired BeanDefinitionDocumentReader
	 ...
	 * 
	 * @param inputSource         the SAX InputSource to read from
	 * @param resourceDescription a description of the resource (can be {@code null}
	 *                            or empty)
	 * @return the number of bean definitions found
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 */
	...
	/**
	 * Determine the validation mode for the specified {@link Resource}. If no
	 * explicit validation mode has been configured, then the validation mode gets
	 * {@link #detectValidationMode detected} from the given resource.
	 * <p>
	 * Override this method if you would like full control over the validation mode,
	 * even when something other than {@link #VALIDATION_AUTO} was set.
	 * 
	...
	/**
	 * Create the {@link BeanDefinitionDocumentReader} to use for actually reading
	...
	/**
	 * Create the default implementation of {@link NamespaceHandlerResolver} used if
	 * none is specified.
	 * <p>
