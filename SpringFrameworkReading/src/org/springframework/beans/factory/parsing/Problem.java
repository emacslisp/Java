...
/**
 * Represents a problem with a bean definition configuration. Mainly serves as
 * common argument passed into a {@link ProblemReporter}.
 *
 * <p>
...
public class Problem {
	 ...
	 * @param location the location within a bean configuration source that
	 *                 triggered the error
	 */
	...
	/**
	 * Get the description of the bean configuration source that triggered the
	 * error, as contained within this Problem's Location object.
	 * 
	 * @see #getLocation()
	 */
