...
/**
 * ComponentDefinition based on a standard BeanDefinition, exposing the given
 * bean definition as well as inner bean definitions and bean references for the
 * given bean.
 *
 * @author Rob Harrop
...
public class BeanComponentDefinition extends BeanDefinitionHolder implements ComponentDefinition {
	...
	/**
	 * This implementations expects the other object to be of type
	 * BeanComponentDefinition as well, in addition to the superclass's equality
	 * requirements.
	 */
	@Override
