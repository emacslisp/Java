...
/**
 * Simple strategy allowing tools to control how source metadata is attached to
 * the bean definition metadata.
 *
 * <p>
 * Configuration parsers <strong>may</strong> provide the ability to attach
...
public interface SourceExtractor {
	...
	/**
	 * Extract the source metadata from the candidate object supplied by the
