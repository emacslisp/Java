...
/**
 * Interface representing an object whose value set can be merged with that of a
 * parent object.
 *
 * @author Rob Harrop
 * @since 2.0
...
public interface Mergeable {
	 ...
	 * <p>
	 * The supplied object is considered the parent, and values in the callee's
	 * value set must override those of the supplied object.
	 * 
