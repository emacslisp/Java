...
/**
 * Editor for {@code java.io.File}, to directly populate a File property from a
 ...
 * Previously, it created a File instance directly from a filename. As of Spring
 * 2.0, it takes a standard Spring resource location as input; this is
 * consistent with URLEditor and InputStreamEditor now.
 *
 * <p>
 * <b>NOTE:</b> In Spring 2.5 the following modification was made. If a file
 * name is specified without a URL prefix or without an absolute path then we
 * try to locate the file using standard ResourceLoader semantics. If the file
 * was not found, then a File instance is created assuming the file name refers
 * to a relative file location.
 *
