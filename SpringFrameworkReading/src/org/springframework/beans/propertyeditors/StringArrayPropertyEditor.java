 ...
 *
 * <p>
 * Strings must be in CSV format, with a customizable separator. By default
 * values in the result are trimmed of whitespace.
 *
 * @author Rod Johnson
...
public class StringArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 * 
	 * @param separator        the separator to use for splitting a {@link String}
	 * @param emptyArrayAsNull {@code true} if an empty String array is to be
	 ...
	 * @param emptyArrayAsNull {@code true} if an empty String array is to be
	 *                         transformed into {@code null}
	 * @param trimValues       {@code true} if the values in the parsed arrays are
	 *                         to be trimmed of whitespace (default is true).
	 */
	 ...
	 *                         trimming an input String. Useful for deleting
