...
public class CustomDateEditor extends PropertyEditorSupport {
	 ...
	 * part, not even with {@code setLenient(false)}. Without an "exactDateLength"
	 * specified, the "01/01/05" would get parsed to "01/01/0005". However, even
	 * with an "exactDateLength" specified, prepended zeros in the day or month part
	 * may still allow for a shorter year part, so consider this as just one more
	 * assertion that gets you closer to the intended date format.
	 * 
	 * @param dateFormat      the DateFormat to use for parsing and rendering
	 * @param allowEmpty      if empty strings should be allowed
