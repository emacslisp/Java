...
/**
 * Editor for a {@link Character}, to populate a property of type
 * {@code Character} or {@code char} from a String value.
 *
 * <p>
 * Note that the JDK does not contain a default {@link java.beans.PropertyEditor
 * property editor} for {@code char}!
 * {@link org.springframework.beans.BeanWrapperImpl} will register this editor
 * by default.
 *
 * <p>
