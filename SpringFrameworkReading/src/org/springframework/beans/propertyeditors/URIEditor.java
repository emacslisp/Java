...
/**
 * Editor for {@code java.net.URI}, to directly populate a URI property instead
 * of using a String property as bridge.
 *
 * <p>
 * Supports Spring-style URI notation: any fully qualified standard URI
 * ("file:", "http:", etc) and Spring's special "classpath:" pseudo-URL, which
 * will be resolved to a corresponding URI.
 *
 * <p>
 * By default, this editor will encode Strings into URIs. For instance, a space
 * will be encoded into {@code %20}. This behavior can be changed by calling the
 * {@link #URIEditor(boolean)} constructor.
 *
 * <p>
 * Note: A URI is more relaxed than a URL in that it does not require a valid
 * protocol to be specified. Any scheme within a valid URI syntax is allowed,
 * even without a matching protocol handler being registered.
 *
...
public class URIEditor extends PropertyEditorSupport {
	...
	/**
	 * Create a new URIEditor, converting "classpath:" locations into standard URIs
	 * (not trying to resolve them into physical resources).
	 * 
	 ...
	 * 
	 * @param classLoader the ClassLoader to use for resolving "classpath:"
	 *                    locations (may be {@code null} to indicate the default
	 *                    ClassLoader)
	 */
