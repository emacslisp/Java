 ...
 * {@link org.springframework.context.ApplicationContext container} might
 * contain a
...
public class ResourceBundleEditor extends PropertyEditorSupport {
	...
	/**
	 * The separator used to distinguish between the base name and the locale (if
	 * any) when {@link #setAsText(String) converting from a String}.
	 */
