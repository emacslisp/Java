...
public class StringTrimmerEditor extends PropertyEditorSupport {
	 ...
	 * Create a new StringTrimmerEditor.
	 * 
	 * @param charsToDelete a set of characters to delete, in addition to trimming
	 *                      an input String. Useful for deleting unwanted line
	 *                      breaks: e.g. "\r\n\f" will delete all new lines and line
	 *                      feeds in a String.
	 * @param emptyAsNull   {@code true} if an empty String is to be transformed
	 *                      into {@code null}
	 */
