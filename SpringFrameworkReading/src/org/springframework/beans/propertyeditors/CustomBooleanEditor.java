 ...
 * UI-caused boolean strings into boolean properties of beans and check them in
 * the UI form.
 *
 * <p>
...
public class CustomBooleanEditor extends PropertyEditorSupport {
	 ...
	 * parsing, i.e. get interpreted as null value. Else, an
	...
	/**
	 * Create a new CustomBooleanEditor instance, with configurable String values
	 * for true and false.
	 * <p>
	 * The "allowEmpty" parameter states if an empty String should be allowed for
	 * parsing, i.e. get interpreted as null value. Else, an
	 ...
	 *                    (VALUE_TRUE), "on" (VALUE_ON), "yes" (VALUE_YES) or some
	 *                    custom value
	 * @param falseString the String value that represents false: for example,
	 *                    "false" (VALUE_FALSE), "off" (VALUE_OFF), "no" (VALUE_NO)
