...
/**
 * Property editor for an array of {@link Class Classes}, to enable the direct
 * population of a {@code Class[]} property without having to use a
 * {@code String} class name property as bridge.
 *
 * <p>
...
public class ClassArrayEditor extends PropertyEditorSupport {
	...
	/**
	 * Create a default {@code ClassEditor}, using the thread context
	 * {@code ClassLoader}.
	 */
	 ...
	 * {@code ClassLoader}.
	 * 
	 * @param classLoader the {@code ClassLoader} to use (or pass {@code null} for
