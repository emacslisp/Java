...
/**
 * Editor for {@code java.nio.file.Path}, to directly populate a Path property
 * instead of using a String property as bridge.
 *
 * <p>
 * Based on {@link Paths#get(URI)}'s resolution algorithm, checking registered
 * NIO file system providers, including the default file system for "file:..."
 * paths. Also supports Spring-style URL notation: any fully qualified standard
 * URL and Spring's special "classpath:" pseudo-URL, as well as Spring's
 * context-specific relative file paths. As a fallback, a path will be resolved
 * in the file system via {@code Paths#get(String)} if no existing
 * context-relative resource could be found.
 *
