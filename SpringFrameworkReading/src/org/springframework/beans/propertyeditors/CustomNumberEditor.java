 ...
 * locale-specific number editor within custom controller code, parsing
 * user-entered number strings into Number properties of beans and rendering
 * them in the UI form.
 *
 * <p>
...
public class CustomNumberEditor extends PropertyEditorSupport {
	...
	/**
	 * Create a new CustomNumberEditor instance, using the default {@code valueOf}
	 * methods for parsing and {@code toString} methods for rendering.
	 * <p>
	 * The "allowEmpty" parameter states if an empty String should be allowed for
	 * parsing, i.e. get interpreted as {@code null} value. Else, an
	...
	/**
	 * Create a new CustomNumberEditor instance, using the given NumberFormat for
