...
public class TypeMismatchException extends PropertyAccessException {
	 ...
	 * 
	 * @param propertyChangeEvent the PropertyChangeEvent that resulted in the
	 *                            problem
	 ...
	 * @param propertyChangeEvent the PropertyChangeEvent that resulted in the
	 *                            problem
	 * @param requiredType        the required target type (or {@code null} if not
	 *                            known)
	...
	/**
	 * Create a new {@code TypeMismatchException} without a
	 * {@code PropertyChangeEvent}.
	 * 
	 * @param value        the offending value that couldn't be converted (may be
	 *                     {@code null})
