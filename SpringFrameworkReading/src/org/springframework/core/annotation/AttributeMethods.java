...
final class AttributeMethods {
	 ...
	 * particular, this method is designed to cover Google App Engine's late arrival
	 * of such exceptions for {@code Class} values (instead of the more typical
	...
	/**
	 * Get the index of the specified attribute, or {@code -1} if the attribute is
	 ...
	 * 
	 * @return {@code true} if there is at least one attribute method with a default
	 *         value
	 */
