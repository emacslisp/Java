...
public abstract class AnnotatedElementUtils {
	 ...
	 * @return the names of all meta-annotations present on the annotation, or an
	 ...
	 * of the same name from higher levels, and {@link AliasFor @AliasFor} semantics
	 * are fully supported, both within a single annotation and within the
	 * annotation hierarchy.
	 * <p>
	 * In contrast to {@link #getAllAnnotationAttributes}, the search algorithm used
	 * by this method will stop searching the annotation hierarchy once the first
	 * annotation of the specified {@code annotationName} has been found. As a
	 * consequence, additional annotations of the specified {@code annotationName}
	 * will be ignored.
	 * <p>
	 * This method follows <em>get semantics</em> as described in the
	 * {@linkplain AnnotatedElementUtils class-level javadoc}.
	 ...
	 * In contrast to {@link #getAllAnnotationAttributes}, the search algorithm used
	 * by this method will stop searching the annotation hierarchy once the first
	 * annotation of the specified {@code annotationType} has been found. As a
	 * consequence, additional annotations of the specified {@code annotationType}
	 * will be ignored.
	 * <p>
	 * This method follows <em>find semantics</em> as described in the
	 * {@linkplain AnnotatedElementUtils class-level javadoc}.
	 ...
	 * {@code annotationTypes} within the annotation hierarchy <em>above</em> the
	 * supplied {@code element}; and for each annotation found, merge that
	 * annotation's attributes with <em>matching</em> attributes from annotations in
	 * lower levels of the annotation hierarchy and synthesize the results back into
	 * an annotation of the corresponding {@code annotationType}.
	 * <p>
	 * {@link AliasFor @AliasFor} semantics are fully supported, both within a
	 * single annotation and within annotation hierarchies.
	 * <p>
