...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
	 ...
	 * and all its <em>key-value</em> pairs.
	 * 
	 ...
	 *                       {@code AnnotationAttributes} instance; never
	 *                       {@code null}
	 * @since 4.2
	 */
	 ...
	 * 
	 * @param attributeName the name of the attribute to get; never {@code null} or
	 *                      empty
	 * @return the value
	 * @throws IllegalArgumentException if the attribute does not exist or if it is
	 ...
	 * strings.
	 * <p>
	 * If the value stored under the specified {@code attributeName} is a string, it
	 ...
	 * classes.
	 * <p>
	 * If the value stored under the specified {@code attributeName} is a class, it
	 * will be wrapped in a single-element array before returning it.
	 * 
	 * @param attributeName the name of the attribute to get; never {@code null} or
	 *                      empty
	 ...
	 * {@code attributeName}.
	 * <p>
	 * If the value stored under the specified {@code attributeName} is an instance
	 * of {@code AnnotationAttributes}, it will be wrapped in a single-element array
	 * before returning it.
	 * <p>
	...
	/**
	 * Get the value stored under the specified {@code attributeName}, ensuring that
	 * the value is of the {@code expectedType}.
	 * <p>
	 * If the {@code expectedType} is an array and the value stored under the
	 * specified {@code attributeName} is a single element of the component type of
	 * the expected array type, the single element will be wrapped in a
	 ...
	 * <p>
	 * If the map is already an {@code AnnotationAttributes} instance, it will be
	 * cast and returned immediately without creating a new instance. Otherwise a
	 * new instance will be created by passing the supplied map to the
	 * {@link #AnnotationAttributes(Map)} constructor.
	 * 
	 * @param map original source of annotation attribute <em>key-value</em> pairs
	 */
	@Nullable
