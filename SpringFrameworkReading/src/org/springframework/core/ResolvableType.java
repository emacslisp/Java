...
public class ResolvableType implements Serializable {
	...
	/**
	 * Return an array of {@link ResolvableType ResolvableTypes} representing the
	 * generic parameters of this type. If no generics are available an empty array
	 * is returned. If you need to access a specific generic consider using the
	 * {@link #getGeneric(int...)} method as it allows access to nested generics and
	 * protects against {@code IndexOutOfBoundsExceptions}.
	 * 
	 * @return an array of {@link ResolvableType ResolvableTypes} representing the
	 *         generic parameters (never {@code null})
	 * @see #hasGenerics()
	 * @see #getGeneric(int...)
	 * @see #resolveGeneric(int...)
	 * @see #resolveGenerics()
	 ...
	 * ignored.
	 * <p>
	 * If this method returns a non-null {@code Class} and {@link #hasGenerics()}
	 * returns {@code false}, the given type effectively wraps a plain
	 * {@code Class}, allowing for plain {@code Class} processing if desirable.
	 * 
	 ...
	 * WildcardTypes} if direct resolution fails; however, bounds of
	 ...
	 * 
	 * @param clazz the class to introspect ({@code null} is semantically equivalent
	 ...
	 * 
	 * @param field               the source field
	 * @param nestingLevel        the nesting level (1 for the outer level; 2 for a
	 *                            nested generic type; etc)
	 * @param implementationClass the implementation class
	 * @return a {@link ResolvableType} for the specified field
	 * @see #forField(Field)
	 */
	 ...
	 * 
	 * @param methodParameter    the source method parameter (must not be
	 *                           {@code null})
	 * @param implementationType the implementation type
	 * @return a {@link ResolvableType} for the specified method parameter
	 * @see #forMethodParameter(MethodParameter)
	 ...
	 * 
	 * @param methodParameter the source method parameter (must not be {@code null})
	 * @param targetType      the type to resolve (a part of the method parameter's
	 *                        type)
	 * @return a {@link ResolvableType} for the specified method parameter
	 * @see #forMethodParameter(Method, int)
	 */
	 ...
	 * a specific nesting level, overriding the target type to resolve with a
	 * specific given type.
	 * 
	 * @param methodParameter the source method parameter (must not be {@code null})
	 * @param targetType      the type to resolve (a part of the method parameter's
