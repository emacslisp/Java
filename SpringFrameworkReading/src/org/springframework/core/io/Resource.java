...
public interface Resource extends InputStreamSource {
	 ...
	 * 
	 * @throws             java.io.FileNotFoundException if the resource cannot be
	 *                     resolved as absolute file path, i.e. if the resource is
	 ...
	 *         {@code null})
	 * @throws             java.io.FileNotFoundException if the underlying resource
	 *                     doesn't exist
