...
/**
 * Base class for JavaBean-style components that need to load properties from
 * one or more resources. Supports local properties as well, with configurable
 * overriding.
 *
...
public abstract class PropertiesLoaderSupport {
	...
	/**
	 * Set local properties, e.g. via the "props" tag in XML bean definitions. These
	 * can be considered defaults, to be overridden by properties loaded from files.
	 */
	 ...
	 * earlier files, in case of overlapping keys. Hence, make sure that the most
	 * specific files are the last ones in the given list of locations.
	 */
	 ...
	 * <p>
	 * "true" is appropriate if the properties file is completely optional. Default
	 * is "false".
	 */
	...
	/**
	 * Set the PropertiesPersister to use for parsing properties files. The default
	 * is DefaultPropertiesPersister.
	 * 
