 ...
 * automatically convert {@code String} location patterns (e.g.
 * {@code "file:C:/my*.txt"} or {@code "classpath*:myfile.txt"}) to
 * {@code Resource} array properties. Can also translate a collection or array
 * of location patterns into a merged Resource array.
 *
 * <p>
 * A path may contain {@code ${...}} placeholders, to be resolved as
 * {@link org.springframework.core.env.Environment} properties: e.g.
 * {@code ${user.dir}}. Unresolvable placeholders are ignored by default.
 *
 * <p>
...
public class ResourceArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 *                                       placeholders if no corresponding system
	 ...
	 * array. Considers String elements as location patterns and takes Resource
	 * elements as-is.
	 */
	@Override
