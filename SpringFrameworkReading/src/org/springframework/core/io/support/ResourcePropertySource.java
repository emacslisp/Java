 ...
 * object from a given {@link org.springframework.core.io.Resource} or resource
 * location such as {@code "classpath:/com/myco/foo.properties"} or
 * {@code "file:/path/to/file.xml"}.
 *
 * <p>
 * Both traditional and XML-based properties file formats are supported;
 * however, in order for XML processing to take effect, the underlying
 * {@code Resource}'s {@link org.springframework.core.io.Resource#getFilename()
 * getFilename()} method must return a non-{@code null} value that ends in
 * {@code ".xml"}.
 *
 * @author Chris Beams
...
public class ResourcePropertySource extends PropertiesPropertySource {
	...
	/**
	 * Return the description for the given Resource; if the description is empty,
	 * return the class name of the resource plus its identity hash code.
	 * 
