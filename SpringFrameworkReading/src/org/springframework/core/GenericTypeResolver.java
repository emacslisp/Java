...
public final class GenericTypeResolver {
	 ...
	 * given target method which is assumed to return the given interface or an
	 * implementation of it.
	 * 
	 * @param method     the target method to check the return type of
	 * @param genericIfc the generic interface or superclass to resolve the type
	 *                   argument from
	 * @return the resolved parameter type of the method return type, or
	 *         {@code null} if not resolvable or if the single argument is of type
	 *         {@link WildcardType}.
	 */
	@Nullable
	...
	/**
	 * Resolve the given generic type against the given context class, substituting
	 * type variables as far as possible.
	 * 
	 ...
	 * {@link Class concrete classes} for the specified {@link Class}. Searches all
