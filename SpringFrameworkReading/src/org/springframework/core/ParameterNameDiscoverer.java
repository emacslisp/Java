...
public interface ParameterNameDiscoverer {
	...
	/**
	 * Return parameter names for a method, or {@code null} if they cannot be
	 * determined.
	 * <p>
	 * Individual entries in the array may be {@code null} if parameter names are
	 * only available for some parameters of the given method but not for others.
	 * However, it is recommended to use stub parameter names instead wherever
	 * feasible.
	 * 
